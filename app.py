...
def favicon():
    return '', 204
def token():
    jwt_token = requests.get("https://steve-jwt-v2.vercel.app/token?uid=4052641394&password=F43E7BF4EED094473196FA60E443A2CE8442AC03D677BAD8F9DBF79E36EC13C8").text
    return jwt_token
...
def main(uid):
    ...
    result['Owners'] = ['@F_O_U_B_I_A • @Bottmk • @LVL_UPV1']
